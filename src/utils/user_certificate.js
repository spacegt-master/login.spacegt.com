...
// 此处key为16进制
let key = CryptoJS.enc.Utf8.parse('359866a57ed21eb0d780abba95cd08c3')
// 偏移量长度为16位, 注：偏移量需要与后端定义好，保证一致
let iv = CryptoJS.enc.Utf8.parse("7ed21eb0d780abba");
...
function decrypt(ciphertext) {
	const decryptedContent = CryptoJS.AES.decrypt(CryptoJS.format.Hex.parse(ciphertext), key, {
		iv: iv,
		mode: CryptoJS.mode.CBC,
		padding: CryptoJS.pad.Pkcs7
	})
